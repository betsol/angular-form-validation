(function (window, angular) {
  ...
  /**
   * Forces validation for entire form.
   *
   * @param {bool} validationForced
   */
  function formForceValidation (validationForced) {
    var ngForm = this;
    // Calling force validation for every child form element.
    angular.forEach(ngForm, function (item) {
      if ('object' === typeof item && 'function' === typeof item.forceValidation) {
  ...
  /**
   * Forces validation for model.
   *
   * @param {bool} validationForced
   */
  function modelForceValidation (validationForced) {
    var model = this;
    model.validationForced = validationForced;
  }
